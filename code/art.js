...
events.forEach((eventType) => {
  document.addEventListener(
    ...
    (e) => {
      ...
      if (width - mouseX <= 200) {
        contextMenu.style.borderRadius = "16px 16px 16px 16px";
...
//terms popup
var maxOpenBtn = document.getElementById("maxOpenBtn");
var maxPopup = document.getElementById("maxPopup");

maxOpenBtn.addEventListener("click", function() {
  maxPopup.style.display = "block";
});

document.addEventListener("click", function(event) {
  if (event.target.id === "maxCloseBtn") {
